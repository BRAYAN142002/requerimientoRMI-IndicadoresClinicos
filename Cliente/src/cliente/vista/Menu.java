...
public class Menu {
                ...
                case 2:
                        ...
                        while(seguirEjecutando) {
                          ...
                          try {
                            ...
                            objRemoto.enviarIndicadores(objPaciente, indicadores);
    ...
    {	 
           indicadoresDTO objIndicadores= new indicadoresDTO(
                   numAleatorioFrecuenciaCardiaca(), numAleatorioTensionArterialSistolica(),numAleatorioTensionArterialDiastolica(), numAleatorioFrecuenciaRespiratoria(), numAleatorioSaturacionOxigeno(), numAleatorioTemperatura());
